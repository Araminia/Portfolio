  ...
  return (
    <section id="contact" className="relative py-28">
      <div className="container">
        ...
        <div className="mt-16 grid gap-10 lg:grid-cols-5">
          ...
          <div className="space-y-4 lg:col-span-2">
            {[
              { icon: Mail, label: "Email", value: "rosascarmina11@gmail.com", href: "mailto:rosascarmina11@gmail.com" },
              { icon: User, label: "Name", value: "Carmina M. Rosas" },
              { icon: MapPin, label: "Based In", value: "Marinduque, Philippines" },
              { icon: Github, label: "GitHub", value: "@carmina-rosas", href: "#" },
            ].map((c) => {
              ...
              return (
                <Tag
                  key={c.label}
                  {...(c.href ? { href: c.href } : {})}
                  className="group flex items-center gap-4 rounded-2xl border border-border bg-card/40 p-5 backdrop-blur transition-all hover:-translate-y-1 hover:border-neon-blue/60 hover:shadow-[0_0_30px_hsl(var(--neon-blue)/0.2)]"
                >
          ...
          >
            ...
            <button
              type="submit"
              disabled={sending}
              className="btn-neon mt-6 w-full justify-center sm:w-auto"
            >
      ...
      <style>{`
        ...
        .neon-input::placeholder { color: hsl(var(--muted-foreground)); }
        .neon-input:focus {
          border-color: hsl(var(--neon-blue));
          box-shadow: 0 0 0 3px hsl(var(--neon-blue) / 0.15), 0 0 25px hsl(var(--neon-blue) / 0.3);
